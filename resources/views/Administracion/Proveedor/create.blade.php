...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
        <h2 style="text-transform:uppercase"><b>Crear Proveedor</b></h2>
        <ol class="breadcrumb">
...
<div class="wrapper wrapper-content animated fadeIn">
    <form class="wizard-big" action="{{ route('Proveedor.store') }}" method="POST" id="form_registrar_proveedor">
        @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6 col-xs-12">
                            ...
                            <input type="text" id="telefono" name="telefono"
                                ...
                                value="{{ old('telefono') }}" maxlength="191">
                        ...
                        <div class="col-md-6 col-xs-12">
                            ...
                            <input type="text" id="numero_documento" name="numero_documento"
                                ...
                                value="{{ old('numero_documento') }}" maxlength="191">
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <input type="text" id="nombre_comercial" name="nombre_comercial"
                                ...
                                value="{{ old('nombre_comercial') }}" maxlength="191">
                    ...
                    <div class="form-group row">
                        <div class="col-md-12 col-xs-12">
                            ...
                            <input type="text" id="direccion" name="direccion"
                                ...
                                value="{{ old('direccion') }}" maxlength="191">
...
<script src="{{ asset('js/Administracion/Proveedor/create.js?v=' . rand()) }}"></script>
@endsection
