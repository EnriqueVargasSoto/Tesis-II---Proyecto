...
@section('Empleados-active', 'active')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10 col-md-10">
            <h2 style="text-transform:uppercase"><b>Listado de Empleado</b></h2>
            <ol class="breadcrumb">
                ...
                <div class="ibox ">
                    <div class="ibox-content">
                        <div class="table-responsive">
                            <table class="table dataTables-empleado table-striped table-bordered table-hover">
                                <thead>
                                    <tr>
...
@section('script')
    ...
    <script src="{{ asset('js/Administracion/Empleado/index.js?v='.rand()) }}">
    </script>
@endsection
