...
@section('Empleados-active', 'active')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10 col-md-10">
            <h2 style="text-transform:uppercase"><b>Editar Empleado</b></h2>
            <ol class="breadcrumb">
    ...
    <div class="wrapper wrapper-content animated fadeIn">
        <form class="wizard-big" action="{{ route('Empleados.editar',$id) }}" method="POST" id="form_editar_empleado">
            @csrf
            @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <input type="text" id="numero_documento" name="numero_documento"
                                    ...
                                    value="{{ old('numero_documento',$empleado->persona->numero_documento) }}"
                                    maxlength="191" >
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 col-xs-12">
                                ...
                                <input type="text" id="apellidoPaterno" name="apellidoPaterno"
                                    ...
                                    value="{{ old('apellidoPaterno',$empleado->persona->apellidoPaterno) }}"
                                    maxlength="191" >
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <input type="text" id="apellidoMaterno" name="apellidoMaterno"
                                    ...
                                    value="{{ old('apellidoMaterno',$empleado->persona->apellidoMaterno) }}"
                                    maxlength="191" >
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 col-xs-12">
                                ...
                                <input type="date" id="fechaNacimiento" name="fechaNacimiento"
                                    ...
                                    value="{{ old('fechaNacimiento',$empleado->persona->fechaNacimiento) }}"
                                    maxlength="191" >
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <input type="text" id="edad" name="edad"
                                    ...
                                    value="{{ old('edad',$empleado->persona->edad) }}"
                                    maxlength="2" >
                                @if ($errors->has('edad'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 col-xs-12">
                                ...
                                <select name="genero" id="genero" class="form-control {{ $errors->has('genero') ? ' is-invalid' : '' }}" >
                                    <option value="M" {{old('genero') ? (old('genero')== "M" ? 'selected' : '') : ($empleado->persona->genero == "M" ? 'selected' : '')}}>Masculino</option>
                                    <option value="F" {{old('genero') ? (old('genero')== "F" ? 'selected' : '') : ($empleado->persona->genero == "F" ? 'selected' : '')}}>Femenino</option>
                                </select>
                            ...
                            <div class="col-md-6 col-xs-12">
                                ...
                                <select name="estadoCivil" id="estadoCivil" class="form-control {{ $errors->has('estadoCivil') ? ' is-invalid' : '' }}">
                                    <option value="Casado"  {{old('estadoCivil') ? (old('estadoCivil')== "Casado" ? 'selected' : '') : ($empleado->persona->estadoCivil == "Casado" ? 'selected' : '')}}>Casada(o)</option>
                                    <option value="Viudo"   {{old('estadoCivil') ? (old('estadoCivil')== "Viudo" ? 'selected' : '') : ($empleado->persona->estadoCivil == "Viudo" ? 'selected' : '')}}>Viuda(o)</option>
                                    <option value="Soltero" {{old('estadoCivil') ? (old('estadoCivil')== "Soltero" ? 'selected' : '') : ($empleado->persona->estadoCivil == "Soltero" ? 'selected' : '')}}>Soltera(o)</option>
                                </select>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <input type="text" id="email" name="email"
                                    ...
                                    value="{{ old('email',$empleado->persona->user->email) }}"
                                    readonly
                                    maxlength="191" >
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6 col-xs-12">
                                ...
                                @foreach (tipos_empleado() as $tipo)
                                    <option value="{{$tipo->id}}" {{old('tipoempleado') ? (old('tipoempleado')==$tipo->id ? 'selected' : '') : ($empleado->tipoempleado_id==$tipo->id ? 'selected' : '')}}>{{$tipo->tipo}}</option>
                                @endforeach
                                </select>
...
<script src="{{asset('js/Administracion/Empleado/edit.js?v='.rand()) }}"></script>
@endsection
