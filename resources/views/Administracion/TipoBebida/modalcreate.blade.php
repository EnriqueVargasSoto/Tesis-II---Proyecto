    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Crear Tipo Bebida</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('TipoBebida.store') }}" id="frm_registrar_tipoBebida" method="POST" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="custom-file">
                                        <input id="logo_create" type="file" name="logo_create" class="custom-file-input" accept="image/*" />
