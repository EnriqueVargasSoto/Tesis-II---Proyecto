...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
        <h2 style="text-transform:uppercase"><b>Crear Doc Compra</b></h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{ route('DocCompra.index') }}">Doc Compra</a>
            </li>
            <li class="breadcrumb-item active">
                <strong>Crear Doc Compra</strong>
            </li>
        </ol>
    </div>
</div>
<div class="wrapper wrapper-content animated fadeIn">
    <div class="card">
        <div class="card-body">
            <form action="{{ route('DocCompra.store') }}" method="post" id="frm_store" enctype="multipart/form-data">
                @csrf
                <div class="row">
                                ...
                                <div class="input-group m-b">
                                    <div class="input-group-prepend">
                                        <span class="input-group-addon">
                                            <input type="checkbox" id="igv" name="igv">
                                        </span>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <p>
                                        ...
                                        <img class="logo img-fluid" src="{{asset('Images/docCompradefault.jpg')}}"
                                            alt="">
...
<script src="{{ asset('js/Compras/DocCompra/create.js?v='.rand()) }}"></script>
@endsection
